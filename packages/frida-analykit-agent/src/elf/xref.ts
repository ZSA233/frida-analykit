...
import type { MemoryPage } from "../helper/index.js"
import { NativePointerObject } from "../internal/frida/pointer_object.js"
import { ScanAdrpCMod } from "./internal/scan_adrp.js"
...
export class AdrlXref {
    ...
    */
    ...
    scanAdrl(
        ...
        help.mem.withReadableRange(base, size, (makeReadable, makeRecovery): void => {
            makeReadable()
    ...
    scanAdrlSlow(
        ...
        help.mem.withReadablePages(base, size, (page: MemoryPage): boolean => {
            const { readable } = page
